...
import { useConsumePushNotification } from '@/features/notifications/usePush'
...
const NAV = [
  ...
  { to: 'dates', label: 'Dates', icon: CalendarClock },
...
function Shell() {
  ...
  // If the app was opened from a Web Push (#267), mark that inbox row read.
